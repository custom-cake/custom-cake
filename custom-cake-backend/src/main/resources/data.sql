...
VALUES (1, 1, '5740901522', '신혜수', '07006', '서울 동작구 사당로 271', '2층', '동작구', "126.972290", "37.4856085", NULL , '레이네 케이크', '레이네 케이크 주문 채널입니다 :)
    ...
    (2, 2, '1208147521', '권정미', '08289', '서울 구로구 새말로 102', '신도림포스빌 지하1층 B123-2호', '구로구', "126.891633", "37.5056805", '0507-1470-0981', '플랑케이크',
    ...
    (3, 3, '6576200712', '김송인', '07957', '서울 양천구 목동중앙남로13길 20', '1층', '양천구', "126.864392", "37.5403584", NULL, '쏘니니 케이', '쏘니니💘 목동케이크 등촌케이크 어버이날케이크
🥚 크림치즈,100% 동물성 생크림사용
🥛 빵시트부터 직접 제작해요! 🥳
