...
class CakeOption1Type {
    enum class CakeShape(@get:JsonValue val type: String) {
        ...
        companion object {
            ...
            fun toMap(): Map<CakeShape, String> = CakeShape.values().associateWith { it.type }
        }
    }
    ...
    enum class CakeSize(@get:JsonValue val type: String) {
        ...
        companion object {
            ...
            fun toMap(): Map<CakeSize, String> = CakeSize.values().associateWith { it.type }
        }
    }
    ...
    enum class CakeLayer(@JsonValue val type: String) {
        ...
        companion object {
            ...
            fun toMap(): Map<CakeLayer, String> = CakeLayer.values().associateWith { it.type }
        }
    }
}
